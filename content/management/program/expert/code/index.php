<?php
	...
	function insert($db){
		...
		by_db("
			insert into `$db`(`id`,`name`,`expertise`,`experience`,`intro`) 
			values(:id,:name,:expertise,:experience,:intro) on duplicate key 
			update `name`=:name,`expertise`=:expertise,`experience`=:experience,`intro`=:intro
		",$_POST);
